    ...
    <Navbar  bg="light" expand="lg">
        <Container fluid className="d-flex justify-content-between">
            ...
            <Form className="d-flex " style={{width: '50%'}}  >
                <input type="text" className="form-control" id="inputPassword" placeholder="Search for videos..." onChange={(e) => setSearchQuery(e.target.value)}  />

                <Button variant="outline-success" onClick={() => navigate(`/search/${SearchQuery}`)}>
