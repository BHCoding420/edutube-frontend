  ...
  return (
    <>
        ...
        <div  className="my-auto" >
          ...
          <Button variant="light" className="mx-2" onClick={User ? addLike : () => {alert("You need to be logged in to react")}}>
              {!Liked ?
          ...
          <Button variant="light" className="mx-2" onClick={User ? addDislike : () => {alert("You need to be logged in to react")} }>
              {!Disliked ?
          ...
          <br/>
          <div className="dropdown d-flex justify-content-start m-2" onClick={() => navigate(`/profile/${file.creator._id}`)}>
